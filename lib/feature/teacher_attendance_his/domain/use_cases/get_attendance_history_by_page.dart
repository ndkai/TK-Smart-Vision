...
class GetTAttendanceHistoryByPage extends UseCase<TAttendanceHistorySwagger, Params>{
  final TAttendanceHistoryRepository repository;

  GetTAttendanceHistoryByPage(this.repository);

  @override
  Future<Either<Failure, TAttendanceHistorySwagger>> call(Params params) {
    // TODO: implement call
