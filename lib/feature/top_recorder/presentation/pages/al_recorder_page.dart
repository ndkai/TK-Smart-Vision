...
class AlRecorderPage extends StatefulWidget {
  static const String routeName = "RecorderPage";
  @override
  _AlRecorderPageState createState() => _AlRecorderPageState();
}

class _AlRecorderPageState extends State<AlRecorderPage> {
  @override
